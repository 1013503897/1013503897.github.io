---
title: 某招聘 App 爱加密抽取壳完整脱壳与请求签名逆向
summary: >-
  爱加密抽取壳完整脱壳：root 读 /proc/pid/mem 绕页权限、DEX 跨区重组、16 DEX/5.5 万类；请求签名 HMAC-SHA256
  纯算复现；FART 补未执行方法。
created: '2026-09-03'
updated: '2026-09-05'
tags:
  ...
  - HMAC
venue: 看雪
target: 某招聘 App（包名 base64 Y29tLmpvYi5hbmRyb2lk）
...
```
$ su -c 'grep TracerPid /proc/<pid>/status'
TracerPid:	8015
```
